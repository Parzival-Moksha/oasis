...
export function buildGeminiLiveSystemInstruction(args: { worldId?: string; worldName?: string; model?: string; voice?: string } = {}): string {
  ...
  return [
    ...
    'Use text_to_pic for framed images, text_to_pic_building for four-sided textured picture buildings, text_to_video for short generated clips, text_to_music for songs, and place_media to drop an existing media URL into the world.',
