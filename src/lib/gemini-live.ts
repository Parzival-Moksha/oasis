...
export const GEMINI_LIVE_AUDIO_INITIAL_JITTER_SECONDS = 0.38
export const GEMINI_LIVE_AUDIO_STARTUP_SMOOTH_SECONDS = 2.4
export const GEMINI_LIVE_AUDIO_STARTUP_MIN_QUEUE_SECONDS = 0.24
export const GEMINI_LIVE_AUDIO_MIN_QUEUE_SECONDS = 0.1
