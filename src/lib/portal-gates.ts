...
export const PORTAL_GATE_VARIANT_DEFS: PortalGateVariantDef[] = [
  ...
  },
  {
    id: 'hologram-gate',
    label: 'Hologram',
    desc: 'A hard-light scan gate with cyan lattice energy.',
    accent: '#22d3ee',
    preview: { from: '#083344', via: '#22d3ee', to: '#0f172a' },
  },
  {
    id: 'solar-arch',
    label: 'Solar Arch',
  ...
  },
  {
    id: 'verdant-arch',
    label: 'Verdant',
    desc: 'A living root arch with firefly motes and emerald mist.',
    accent: '#86efac',
    preview: { from: '#052e16', via: '#22c55e', to: '#dcfce7' },
  },
  {
    id: 'mirror-pool',
    label: 'Mirror Pool',
    desc: 'A liquid vertical pool with moonlit ripples.',
    accent: '#7dd3fc',
