...
describe('realtime voice server guardrails', () => {
  ...
  it('exposes direct self-craft alongside prompt craft for realtime sessions', async () => {
    ...
    expect(names).toContain('list_ground_presets')
    expect(names).toContain('query_objects')
    expect(names).toContain('modify_object')
    expect(names).toContain('set_sky')
    expect(names).toContain('set_ground_preset')
    expect(names).toContain('create_portal_gate')
    expect(names).toContain('text_to_pic')
    expect(names).toContain('text_to_pic_building')
    expect(names).toContain('text_to_video')
    expect(names).toContain('text_to_music')
    expect(names).toContain('place_media')
    ...
    expect(readRealtimePromptTemplate()).toContain('set_sky')
