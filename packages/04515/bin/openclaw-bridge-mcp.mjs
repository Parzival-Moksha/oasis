...
} from '../lib/oasis-tool-spec.js'
import {
  PUBLIC_TOOL_NAMES,
  requiredScopeForPublicTool,
} from '../lib/public-spellbook.js'
  ...
  const server = new McpServer(
    { name: 'openclaw-oasis-relay-mcp', version: '0.3.0' },
    {
      ...
      instructions: [
        ...
        'For procedural building, call get_craft_guide and then self_craft_scene with explicit primitive objects. Do not use prompt-sculpting in hosted mode.',
