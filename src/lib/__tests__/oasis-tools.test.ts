...
describe('TOOL_NAMES', () => {
  ...
  it('includes key tools', () => {
    ...
    expect(TOOL_NAMES).toContain('text_to_pic')
    expect(TOOL_NAMES).toContain('text_to_pic_building')
    expect(TOOL_NAMES).toContain('text_to_video')
    expect(TOOL_NAMES).toContain('text_to_music')
    expect(TOOL_NAMES).toContain('place_media')
